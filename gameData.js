    ...
    scenes: {
        ...
        wakeUp: {
            ...
            dialogue: [
                ...
                {
                    text: "I'm KOVI! GREAT NEWS, champ! Your wishlist application is COMPLETE! BUT WAIT... OH NO, your money memories didn't survive the body swap! We gotta fix your brain to complete the application.",
                    speaker: 'KOVI',
                    brain: true,
                    brainPhase: 3
                },
                    ...
                    text: function(choices) {
                        ...
                        if (investments.length > 0) {
                            ...
                            if (hasRealEstate && hasCrypto) {
                                return "Property AND crypto? Your neurons are living in the 1800s AND 2077 simultaneously! Collecting rent while jacking into the blockchain—timeline fucking BROKEN!";
                            }
